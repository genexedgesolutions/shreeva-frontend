...
export const PolicyPages = [
  ...
  { href: "/refund-return", name: "Refund Return" },
...
export const shop_by_price = [
  { href: "#", name: "Under ₹999" },
  { href: "#", name: "₹1000 - ₹1499" },
  { href: "#", name: "₹1500 & Above" },
];

export const shopByUse = [
  { href: "#", name: "Hair Care" },
  { href: "#", name: "Skin Hydration" },
  { href: "#", name: "Sun Protection" },
  { href: "#", name: "Daily Skincare Routine" },
];
...
export const productLink = [
  { href: "/product/rice-water-toner", name: "Rice Water Toner" },
  { href: "/product/rice-based-moisturiser", name: "Rice Based Moisturiser" },
  { href: "/product/rice-spf50-sunscreen", name: "Rice + SPF 50 Sunscreen" },
];
