...
export const testimonialsShreeva = [
  {
    id: 1,
    author: "Neha Kapoor",
    location: "Mumbai, Maharashtra",
    text: `"I was searching for elegant diamond jewelry that matched my modern style but was also sustainable. Shreeva Jewels exceeded my expectations. The lab-grown diamond pendant I bought is breathtaking—sparkling, flawless, and so affordable compared to mined diamonds. I’ve worn it to both office meetings and family functions, and I always get compliments!"`,
    avatar: "/images/avatar/user-1.jpg",
    product: "Lab-Grown Diamond Pendant",
    price: "₹19,999.00",
  },
  {
    id: 2,
    ...
    text: `"I gifted my wife a pair of Shreeva Jewels’ diamond earrings for our anniversary, and she was over the moon. The craftsmanship is stunning and the diamonds shine brilliantly in any light. I love that I could give her something timeless and ethical at the same time. Truly a brand that combines luxury with responsibility."`,
  ...
  },
  {
    ...
    text: `"Being a minimalist, I wanted jewelry that felt personal yet elegant. Shreeva Jewels’ solitaire ring was exactly what I dreamed of. It’s simple, classy, and goes with everything I wear. The fact that it’s lab-grown makes me feel good about my choice for the planet too. Definitely recommending Shreeva to all my friends."`,
